...
window.setTimeout(function () {
    $(".ifr-hide").fadeTo(900, 0).slideUp(800, function () {
        $(this).remove();
    });
}, 5000);
...
$(".lightTheme").on("click", function () {
    $("body").removeClass("dark theme-black logo-black menu_dark");
    $("body").addClass("light theme-blue logo-white menu_light");
    ...
    $("body").removeClass("menu_blue theme-blue light logo-white menu_light");
    $("body").addClass("dark theme-black logo-black menu_dark");
...
if (localStorage.getItem("theme")) {
    $("body").removeClass("dark light menu_blue theme-blue");
